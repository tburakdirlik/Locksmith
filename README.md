...
A credential authentication testing tool for penetration testing. Uses NetExec (nxc) as a wrapper to test username and password combinations across multiple protocols.
